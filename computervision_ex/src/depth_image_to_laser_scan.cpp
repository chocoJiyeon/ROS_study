...
double scan_time_ = 0.033, range_max_ = 1.0, range_min_ = 0.45;
...
int main(int argc, char **argv)
{
  ...
  image_transport::CameraSubscriber cam_sub = it.subscribeCamera("/camera/depth/image_raw", 1, depthImgCallback);
