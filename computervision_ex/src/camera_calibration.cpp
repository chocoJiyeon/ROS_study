...
int main(int argc, char **argv) 
{
  ...
  cv::glob("/home/cona/catkin_ws/src/jy_project/computervision_ex/images/109_frontal_camera/cap_img*.png", captured_img, false);
  // cv::Size patternSize(11 - 1, 8 - 1);
  cv::Size patternSize(9 - 1, 7 - 1);
  ...
  for (auto const &f : captured_img) 
  {
    ...
    // [TEST] std::cout<<"pattern found : "<<patternFound<<std::endl;
  ...
  // cv::Size frameSize(1280, 720); //wabcam
  cv::Size frameSize(640, 400);    // RGB-D astra
